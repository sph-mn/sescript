(define-test-module (test module sph lang sescript)
  ...
  (test-execute-procedures-lambda
    (sescript->ecmascript
      ...
      (define a (lambda (a b) 1 2 3)) "var a=(function(a,b){1;2;3});"
      ...
      (if* 1 (lambda () #t) 2) "(1?(function(){true}):2);"
      (if* (not 1) a b) "(!1?a:b);"
      (lambda (a) 1) "(function(a){1});"
      ((lambda (a) 1)) "(function(a){1})();"
      (let (a 1) 2) "(function(a){2})(1);"
      (let ((a 1) (b 2)) #t) "(function(a,b){true})(1,2);"
      (let* ((a 1) (b 2) (c 3)) 4) "(function(a){var b=2;var c=3;4})(1);"
