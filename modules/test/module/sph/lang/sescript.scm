(define-test-module (test module sph lang sescript) (import (sph list) (sph lang sescript))
  ...
  (test-execute-procedures-lambda
    (sescript->ecmascript
      ...
      (lambda (a b . c) c)
      (unquote
        (string-append "(function(a,b){var c=new Array(arguments.length);for(var ___i=2;"
          "___i<arguments.length;___i+=1)" "{c.push(arguments[___i])}return(c)});"))
      (set! a 1) "a=1;"
      (ref a 1) "a[1];"
      (ref a 1 2 3) "a[1][2][3];"
      (ref (ref a 1) 2) "a[1][2];"
      ...
      (cond ((= a 1) (equal? b 2)) ((equal? c 3) #t)) "((a==1)?(b===2):((c===3)?true:undefined));"
      (cond ((= a 1) (equal? b 2)) ((equal? c 3) #f #t) (else #t #f))
      "((a==1)?(b===2):((c===3)?(false,true):(true,false)));" (case (+ 1 2) (2 #f) (3 #t))
      ...
      (guard (exc (else #f)) 1) "(function(){try{return(1)}catch(exc){return(false)}})();"
